    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-500">
          {isLogin ? "Enter your details to access your dashboard." : "Start diagnosing your errors with AI."}
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-white py-8 px-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 sm:rounded-3xl sm:px-10">
            ...
            <div>
              ...
              <div className="mt-2 relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 sm:text-sm transition-all"
          ...
          <div className="mt-8 text-center">
            <button type="button" onClick={() => { setIsLogin(!isLogin); setErrorMsg(null); }} className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
